...
fprintf('\n');
fprintf('--|---------------------|-----------------------|-----------------------|------------------------\n');
fprintf('I |M. de Newton Raphson |      Error aprox      |M.Newton Raphson Modif |      Error aprox      |\n');
fprintf('--|---------------------|-----------------------|-----------------------|------------------------\n');
fxi = inline(funcion);%Guarda la funcion original para posterior ser evaluado con el valor de xi
EstAnteriorMNRN = 0; %La Estimacion Anterioor en la Primera iteracion es = 0, para el metodo de Newton Raphson Normal
EstAnteriorMNRF = 0; %La Estimacion Anterioor en la Primera iteracion es = 0, para el Metodo de Newton Raphson Modificado
xi1 = xi;
xi2 = xi;
...
for i = 1: n
    ...
    fprintf('%2d|    %12.9f     |    %12.8f       |  %12.8f         |  %12.8f        |\n', i, MNRNormal, MNRNError, MNRModificado, MNRMError);
    fprintf('--|---------------------|-----------------------|-----------------------|------------------------\n');
